                ...
                <div className="row gap-0">
                    ...
                    <div className="contact-card col-lg-6 mt-5">
                        <div className="contact-card card shadow border-0">
                            ...
                            <div className="btn contact-btn border-0 ms-4 fw-medium fs-1"> Send Message</div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-6 mt-5">
                        ...
                        <div className="row">
                            <div className="col-lg-6 mt-3">
                                <div className="contact-logo"><SlLocationPin size={40} /></div>
                                <h4>Location</h4>
                                <p className='text-secondary'>Jl. Sunset Road No. 815, Kuta
                                    p
                                </p>
                            </div>
                            <div className="col-lg-6 mt-3">
                                <div className="contact-logo"><IoMailOpenOutline size={40} /></div>
                                <h4>Email</h4>
                        ...
                        <div className="row">
                            <div className="col-lg-6 mt-3">
                                <div className="contact-logo"><LuPhone size={40} /></div>
                                <h4>Phone</h4>
                                <p className='text-secondary'>(+62) 81 2345 1234</p>
                            </div>
                            <div className="col-lg-6 mt-3">
                                <div className="contact-logo">
                                    <FaRegClock size={40} /></div>
                                <h4>Opening Hours</h4>
                                <p className='text-secondary'>Mon - Fri : 09.00 AM - 18.00 PM</p>
                            </div>
                        </div>
