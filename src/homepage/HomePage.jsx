                    ...
                    <div className="carousel-item active position-relative">
                        <div className="carousel-content-wrapper ">
                            ...
                            <div className="col-lg-6 carousel-caption fw-bold d-none d-md-block position-absolute top-2 start-0">
                                ...
                                <p className='col-lg-12 fw-normal text-white' data-aos="fade-left">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                            </div>
                        </div>
                        <div className="imgs d-flex align-items-center justify-content-around gap-4 position-absolute bottom-0 start-0">
                            <div className="button1">
                                <button className='btn text-light px-5 py-3 rounded-3 fw-bold' data-aos="fade-right">LEARN MORE</button>
                            </div>
                            <div className="button2">
                                <button className='btns d-flex align-items-center justify-content-around gap-4'>
                                    <div className="watch" data-aos="fade-up"> <MdOutlinePlayCircle size={45} /></div>
                                    <div className="w fw-normal" data-aos="fade-left">WATCH INTRO</div> </button>
                        ...
                        <div className="carousel-content-wrapper">
                            ...
                            <div className="imgs d-flex align-items-center justify-content-around gap-4 position-absolute bottom-0 start-0">
                                ...
                                <div className="button2">
                                    <button className='btns d-flex align-items-center justify-content-around gap-4'>
                                        <div className="watch" data-aos="fade-up"> <MdOutlinePlayCircle size={45} /></div>
                                        <div className="fw-normal" data-aos="fade-left">WATCH INTRO</div> </button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="carousel-item position-relative">
                        ...
                        <div className="imgs d-flex align-items-center justify-content-around gap-4 position-absolute bottom-0 start-0">
                            ...
                            <div className="button2">
                                <button className='btns d-flex align-items-center justify-content-around gap-4'>
                                    <div className="watch" data-aos="fade-up"> <MdOutlinePlayCircle size={45} /></div>
                                    <div className="fw-norma" data-aos="fade-left" l>WATCH INTRO</div> </button>
                            </div>
                        </div>
                    </div>
                </div>
