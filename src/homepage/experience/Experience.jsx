            ...
            <div className="container-fluid exp-img mt-5">
                <div className="pro row  mb-5 mx-auto text-center text-white align-items-center justify-content-around mt-5">
                    <div className="col-lg-3 mt-5" data-aos="fade-up">
                        <div className="pro d-flex flex-column justify-content-start align-items-center mx-auto text-center text-white mt-2">
                            ...
                            <div className="d-flex align-items-center justify-content-around gap-2">
                                <div className="digits"><h2 className='mt-2'>125</h2></div>
                                <div className="digits-i"><FaPlus size={13} color='purple' /></div>
                            </div>
                            <h6 className='fw-bold'>Projects Done</h6>
                        </div>
                    </div>
                    <div className="col-lg-3 mt-5" data-aos="fade-up"><div className="d-flex flex-column justify-content-start align-items-center mt-2">
                        <FaRegFaceLaughBeam size={50} color='purple' />
                        <div className="d-flex align-items-center justify-content-around gap-2">
                            <div className="digits-i"><h2 className='mt-2'>200</h2> </div>
                            <div className="digits-i">
                    ...
                    <div className="col-lg-3 mt-5" data-aos="fade-up"><div className="d-flex flex-column justify-content-start align-items-center mt-2">
                        ...
                        <div className="d-flex align-items-center justify-content-around gap-2">
                            <div className="digits-i"> <h2 className='mt-2'>199</h2> </div>
                            <div className="digits-i">
                                <FaPlus size={13} color='purple' />
                            </div>
                        </div>
